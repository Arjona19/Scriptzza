...
//---------------------------------------
   ...
   public void Load() throws SQLException {
        ...
        colum3.setPrefWidth(90);
        colum3.setCellValueFactory(new Callback<TreeTableColumn.CellDataFeatures<Paqu, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TreeTableColumn.CellDataFeatures<Paqu, String> param) {
        ...
        colum4.setPrefWidth(90);
        colum4.setCellValueFactory(new Callback<TreeTableColumn.CellDataFeatures<Paqu, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TreeTableColumn.CellDataFeatures<Paqu, String> param) {
        ...
        colum5.setPrefWidth(90);
        colum5.setCellValueFactory(new Callback<TreeTableColumn.CellDataFeatures<Paqu, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TreeTableColumn.CellDataFeatures<Paqu, String> param) {
        ...
        colum6.setPrefWidth(100);
        colum6.setCellValueFactory(new Callback<TreeTableColumn.CellDataFeatures<Paqu, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TreeTableColumn.CellDataFeatures<Paqu, String> param) {
        ...
        colum7.setPrefWidth(100);
        colum7.setCellValueFactory(new Callback<TreeTableColumn.CellDataFeatures<Paqu, String>, ObservableValue<String>>() {
            @Override
            public ObservableValue<String> call(TreeTableColumn.CellDataFeatures<Paqu, String> param) {
        ...
        tabla.getColumns().setAll(colum1,colum2,colum3,colum4,colum5,colum6,colum7);
        tabla.setRoot(root);
  ...
  //--------------------------------------  
    ...
    public int Modificar(Paquete paquetes){
        ...
        "',ingrediente3='"+paquetes.getIngrediente3()+"',bebida='"+paquetes.getBebida()+"',dip='"+paquetes.getDip()+
                "' WHERE ID_p="+paquetes.getId_paquete());
        objConexion.Desconectar();
        return ComandoEjecutado;
    }
}
